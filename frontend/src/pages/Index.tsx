...
const Index = () => {
  ...
  const [style, setStyle] = useState<
    "formal" | "casual" | "aggressive" | "technical"
  >("formal");
  ...
  const featureConstellation = [
    {
      ...
      description:
        "Experience natural conversations with an AI that adapts to your responses and asks thoughtful follow-up questions.",
      features: [
    ...
    },
    {
      ...
      description:
        "Get instant feedback on your communication patterns, confidence levels, and areas for improvement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Receive curated learning resources and practice recommendations based on your performance.",
      features: [
    ...
    },
    {
      ...
      description:
        "Powered by cutting-edge STT & TTS for crystal-clear voice recognition and natural speech synthesis.",
      features: [
    ...
    },
    {
      ...
      description:
        "Bank-level encryption and secure cloud storage ensure your interview data remains private and protected.",
      features: [
  ...
  const interviewStyles = [
    {
      value: "formal",
      label: "Professional",
      description: "Traditional corporate interview style",
      color: "blue",
    },
    {
      value: "casual",
      label: "Conversational",
      description: "Relaxed and friendly approach",
      color: "green",
    },
    {
      value: "technical",
    ...
    },
    {
      value: "aggressive",
      label: "Challenging",
      description: "High-pressure scenario simulation",
      color: "red",
    },
  ];
  ...
  const difficultyLevels = [
    {
      value: "easy",
      label: "Beginner",
      description: "Basic questions, gentle pace",
      bars: 1,
      color: "green",
    },
    {
      value: "medium",
      label: "Intermediate",
      description: "Standard interview complexity",
      bars: 2,
      color: "orange",
    },
    {
      value: "hard",
      label: "Advanced",
      description: "Complex scenarios and follow-ups",
      bars: 3,
      color: "red",
    },
  ];
  ...
  const handleStartInterview = () => {
    if (!jobRole.trim()) {
      ...
      toast({
        ...
        description:
          "Please enter a job role to start your interview practice.",
        variant: "destructive",
      });
    ...
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.15) 50%, transparent 100%)",
            filter: "blur(2px)",
          }}
        />
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="max-w-6xl mx-auto text-center">
          {/* Refined Badge */}
          <div
            className={`inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-8 py-3 sm:py-4 rounded-full bg-black/30 backdrop-blur-md border border-white/10 mb-8 sm:mb-12 transition-all duration-1000 ${
              isVisible
          ...
          <div
            className={`space-y-4 sm:space-y-8 mb-8 sm:mb-12 transition-all duration-1000 delay-200 ${
              isVisible
                ? "opacity-100 transform-none"
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black leading-tight tracking-tight">
              <div className="text-white/95 mb-2 sm:mb-3">Master Your</div>
              <div className="text-white/95">Interview Skills</div>
            </h1>
          ...
          <div
            className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 sm:mb-16 px-4 sm:px-0 transition-all duration-1000 delay-400 ${
              isVisible
                ? "opacity-100 transform-none"
                : "opacity-0 translate-y-8"
            }`}
          ...
          <div
            className={`hidden sm:block transition-all duration-1000 delay-600 ${
              isVisible
                ? "opacity-100 transform-none"
                : "opacity-0 translate-y-8"
            }`}
        ...
        <div className="max-w-7xl 2xl:max-w-none mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-600/20 border border-purple-500/30 backdrop-blur-sm mb-4 sm:mb-6">
              ...
              <span className="text-xs sm:text-sm font-semibold text-cyan-300 tracking-wider">
            ...
            <p className="text-gray-400 text-base sm:text-xl max-w-3xl xl:max-w-4xl mx-auto leading-relaxed px-4 sm:px-0">
              Configure every aspect of your practice session with our
              intelligent wizard
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div
                  className={`p-2 sm:p-3 rounded-xl shadow-lg transition-all duration-300 ${
                    showRequiredError
                ...
                <div className="flex items-center gap-2">
                  <span
                    className={`px-2 sm:px-4 py-1 sm:py-2 rounded-full font-medium text-xs sm:text-sm transition-all duration-300 ${
                      showRequiredError
                ...
                {popularRoles.map((role, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center space-x-2 sm:space-x-3">
                      <span className="text-xl sm:text-2xl transform group-hover/role:scale-110 transition-transform duration-300">
                        {role.icon}
                      </span>
              ...
              <div className="bg-gradient-to-br from-orange-900/30 via-black/80 to-orange-900/30 backdrop-blur-3xl border border-orange-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl hover:shadow-orange-500/10 transition-all duration-500">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <input
                    ...
                    onChange={(e) =>
                      setInterviewDuration(parseInt(e.target.value))
                    }
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    ...
                    <span
                      className={
                        interviewDuration > 10 && interviewDuration <= 20
                          ? "text-yellow-400"
                          : "text-gray-500"
                      }
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5">
                {interviewStyles.map((styleOption) => (
                  ...
                  >
                    {/* Advanced hover glow */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br from-${styleOption.color}-500/10 to-${styleOption.color}-600/10 opacity-0 group-hover/style:opacity-100 transition-opacity duration-500 rounded-xl`}
                    ></div>

                    <div className="relative">
                      <div className="text-base sm:text-lg font-bold mb-2 sm:mb-3">
                        {styleOption.label}
                      </div>
                      ...
                      {style === styleOption.value && (
                        <div className="absolute top-0 right-0">
                          <div
                            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-${styleOption.color}-500 animate-pulse`}
                          ></div>
                        </div>
                      )}
                    </div>
                ...
                {resumeContent ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-400 text-sm">
                      AI will use this to create personalized interview
                      questions
                    </p>
                    <button
          ...
          <div className="text-center">
            ...
            {!jobRole.trim() && (
              <p className="mt-4 text-gray-400 text-sm">
                💡 Choose a job role above to start your personalized interview
                practice
              </p>
            )}
          </div>
  ...
  const renderFeatureConstellation = () => {
    const hoveredFeatureData = featureConstellation.find(
            ...
            <div
              ...
              style={{
                background: `radial-gradient(circle, ${
                  featureConstellation[i % featureConstellation.length].color
                }, transparent)`,
                left: `${15 + ((i * 7) % 80)}%`,
                top: `${10 + ((i * 11) % 80)}%`,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-400 max-w-4xl mx-auto leading-relaxed px-4 sm:px-0">
              Discover our comprehensive AI system through an interactive
              experience
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* Feature label */}
                    <div
                      className={`absolute -bottom-8 sm:-bottom-10 left-1/2 transform -translate-x-1/2 whitespace-nowrap transition-all duration-300 ${
                        isHovered
          ...
          <div className="text-center mt-12 sm:mt-16">
            <p className="text-gray-400 text-base sm:text-lg mb-3 sm:mb-4 px-4 sm:px-0">
              ...
              <span className="sm:hidden">Tap</span> the floating elements to
              explore our AI system features
            </p>
          ...
          <div className="max-w-5xl xl:max-w-6xl mx-auto">
            <div className="flex flex-col items-center justify-center">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-2 text-xl font-bold bg-gradient-to-r from-cyan-300 via-purple-400 to-pink-300 bg-clip-text text-transparent">
                  AI Interviewer
                </h3>
              </div>

              <p className="text-gray-400 text-center mb-4 max-w-md">
                Enhance your interview skills with our AI-powered simulator.
                Practice, get feedback, and improve.
              </p>

              <div className="flex justify-center space-x-4 mb-6">
                <a
                  href="https://github.com/Tushar25v/interview-AI"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-black/40 backdrop-blur-xl border border-white/10 p-3 rounded-full hover:border-cyan-500/30 hover:shadow-cyan-500/20 transition-all duration-300"
                >
                  <Github className="h-5 w-5 text-gray-300 hover:text-cyan-400" />
                </a>
                <a
                  href="https://x.com/tushar_varale"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-black/40 backdrop-blur-xl border border-white/10 p-3 rounded-full hover:border-purple-500/30 hover:shadow-purple-500/20 transition-all duration-300"
                >
                  <Twitter className="h-5 w-5 text-gray-300 hover:text-purple-400" />
                </a>
                <a
                  href="https://www.linkedin.com/in/tushar-varale-703991192/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-black/40 backdrop-blur-xl border border-white/10 p-3 rounded-full hover:border-pink-500/30 hover:shadow-pink-500/20 transition-all duration-300"
                >
                  <Linkedin className="h-5 w-5 text-gray-300 hover:text-pink-400" />
                </a>
                <a
                  href="mailto:tushar.000varale@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-black/40 backdrop-blur-xl border border-white/10 p-3 rounded-full hover:border-cyan-500/30 hover:shadow-cyan-500/20 transition-all duration-300"
                >
