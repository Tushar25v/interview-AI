    ...
    <>
      <header className="absolute top-0 left-0 right-0 z-50 bg-transparent py-4 sm:py-6">
        <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 max-w-7xl 2xl:max-w-none">
          {/* Logo and Title */}
          <div
            className="flex items-center gap-2 sm:gap-3 cursor-pointer hover:scale-105 transition-transform duration-200"
          ...
          >
            ...
            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-cyan-300 via-purple-400 to-pink-300 bg-clip-text text-transparent font-display tracking-tight hover:from-cyan-200 hover:via-purple-300 hover:to-pink-200 transition-all duration-200">
              AI Interviewer
            </h1>
          </div>
          ...
          {!isMobile && (
            <div className="flex items-center gap-4 lg:gap-6 xl:gap-8">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                <a
                  href="https://github.com/Tushar25v"
                  target="_blank"
                ...
                >
                  <svg
                    className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-400 group-hover:text-blue-400 transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                {user ? (
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="glass-effect rounded-xl px-2 sm:px-3 py-1.5 sm:py-2 flex items-center gap-1.5 sm:gap-2">
                      ...
                      <span className="text-xs sm:text-sm text-gray-300 truncate max-w-24 sm:max-w-none">
